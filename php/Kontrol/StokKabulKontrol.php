<?php
	...
	require_once($_SERVER["DOCUMENT_ROOT"]."/Bitirme/php/Model/StokKabulIslemleri.php");

	class StokKabulKontrol implements IKontrol{

		private $islem;

		public function __construct(){
			$this -> islem = new StokKabulIslemleri();
		}
